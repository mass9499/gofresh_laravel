                ...
                <div class="row">
                    ...
                    @if(isset($config) && $config['status'])
                        ...
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card">
                                <div class="card-body" style="height: 70px">
                                    <form class="needs-validation" method="POST" id="payment-form-paymob" action="{{route('paymob-credit')}}">
                                        {{ csrf_field() }}
                                        <button class="btn btn-block" id="bKash_button" onclick="BkashPayment()">
...
<script type="text/javascript">
    ...
    function createPayment(request) {
        ...
        request['amount'] = "{{isset($amount) ? round(($amount),2):''}}"; // max two decimal points allowed
        $.ajax({
