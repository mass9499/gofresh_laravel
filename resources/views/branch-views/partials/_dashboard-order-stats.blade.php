        ...
        <div class="row gx-lg-4">
            <div class="col-sm-6 col-lg-3">
                <div class="media" style="cursor: pointer"
                    ...
                    <div class="media-body">
                        <h6 class="card-subtitle">{{\App\CentralLogics\translate('All')}}</h6>
                        <span
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media" style="cursor: pointer"
                    ...
                    <div class="media-body">
                        <h6 class="card-subtitle">{{\App\CentralLogics\translate('delivered')}}</h6>
            ...
            <div class="col-sm-6 col-lg-3 column-divider-lg">
                <div class="media" style="cursor: pointer"
                    ...
                    <div class="media-body">
                        <h6 class="card-subtitle">{{\App\CentralLogics\translate('returned')}}</h6>
                        <span
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media" style="cursor: pointer"
                    ...
                    <div class="media-body">
                        <h6 class="card-subtitle">{{\App\CentralLogics\translate('failed')}}</h6>
                        <span
