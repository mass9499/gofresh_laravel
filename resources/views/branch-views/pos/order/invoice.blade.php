            ...
            @if($detail->product)
                <tr>
                    ...
                    <td class="">
                        ...
                        <span style="display: block">{{\App\CentralLogics\translate('Discount')}} : {{$detail['discount_on_product']*$detail['quantity'] .' '.\App\CentralLogics\Helpers::currency_symbol()}}</span>
                    </td>
                    <td style="width: 28%">
    ...
    <div class="row justify-content-md-end">
        <div class="col-md-7 col-lg-7">
            <dl class="row text-right" style="color: black!important;">
                ...
                {{--                <dd class="col-6">{{$sub_total+$total_tax." ".\App\CentralLogics\Helpers::currency_symbol()}}</dd>--}}
