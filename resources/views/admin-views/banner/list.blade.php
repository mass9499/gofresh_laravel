        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{\App\CentralLogics\translate('banner')}} {{\App\CentralLogics\translate('list')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="col-md-4">
                            <h5>{{\App\CentralLogics\translate('Banner Table')}} <span style="color: red;">({{ $banners->total() }})</span></h5>
                        </div>
