                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="d-block">{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('pending')}} {{\App\CentralLogics\translate('message')}}</span>
                                          </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block"> {{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('confirmation')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block">{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('processing')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block">{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('out_for_delivery')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block">{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('delivered')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block">{{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('assign')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block"> {{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('start')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span class="d-block">{{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('delivered')}} {{\App\CentralLogics\translate('message')}}</span>
                                              </span>
                                        </label>
