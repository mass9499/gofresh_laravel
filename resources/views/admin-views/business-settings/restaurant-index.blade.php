                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="alert alert-warning sticky-top" id="alert_box" style="display:none;">
                                ...
                                <strong>Warning!</strong> {{\App\CentralLogics\translate('language_warning')}} For
                                documentaion <a
                                    href="https://documentation.6amtech.com/grofresh/docs/1.0/app-setup#section3"
                                    target="_blank">click
                                    here</a>.
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('email')}} {{\App\CentralLogics\translate('verification')}}
                                    ( OTP
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('phone')}} {{\App\CentralLogics\translate('verification')}}
                                    ( OTP
                                    )</label><small style="color: red">*</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-center">{{\App\CentralLogics\translate('delivery_management')}}</h5>
                                        @php($config=\App\CentralLogics\Helpers::get_business_settings('delivery_management'))

                                        <div class="form-group mb-2">
                                            <label
                                                class="control-label">{{\App\CentralLogics\translate('delivery')}} {{\App\CentralLogics\translate('status')}}</label>
                                        </div>
                                        <div class="form-group mb-2 mt-2">
                                            <input type="radio" name="shipping_status" value="1"
                                                   {{$config['status']==1?'checked':''}} id="shipping_by_distance_status">
                                            <label
                                                style="padding-left: 10px">{{\App\CentralLogics\translate('delivery_charge_by_distance')}}</label>
                                            <br>
                                        </div>
                                        <div class="form-group mb-2">
                                            ...
                                            <label
                                                style="padding-left: 10px">{{\App\CentralLogics\translate('default_delivery_charge')}}</label>
                                            <br>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label
                                                style="padding-left: 10px">{{\App\CentralLogics\translate('minimum_shipping_charge')}} </label><br>
                                        ...
                                        <div class="form-group mb-2">
                                            <label
                                                style="padding-left: 10px">{{\App\CentralLogics\translate('shipping_charge_per_km')}}</label><br>
                        ...
                        <div class="col-md-6 col-12" id="ifYes">
                            @php($delivery=\App\Model\BusinessSetting::where('key','delivery_charge')->first()->value)
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{\App\CentralLogics\translate('default_delivery_charge')}} </label>
                    ...
                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                            ...
                            class="btn btn-primary mb-2">{{\App\CentralLogics\translate('submit')}}</button>
                </form>
            </div>
        </div>
    </div>
