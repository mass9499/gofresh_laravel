                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{\App\CentralLogics\translate('customer')}} {{\App\CentralLogics\translate('details')}}</li>
                        </ol>
                    </nav>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th style="width: 50%" class="text-center">{{\App\CentralLogics\translate('order')}} {{\App\CentralLogics\translate('id')}}</th>
