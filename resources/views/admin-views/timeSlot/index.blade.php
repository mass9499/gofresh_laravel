        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{\App\CentralLogics\translate('Time Slot')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1"> {{\App\CentralLogics\translate('Time')}} {{\App\CentralLogics\translate('Start')}} </label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1"> {{\App\CentralLogics\translate('Time')}} {{\App\CentralLogics\translate('Ends')}} </label>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{\App\CentralLogics\translate('Start')}} {{\App\CentralLogics\translate('Time')}} </th>
                                <th class="text-center">{{\App\CentralLogics\translate('End')}} {{\App\CentralLogics\translate('Time')}}  </th>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('admin.timeSlot.update',[$timeSlot['id']])}}">{{\App\CentralLogics\translate('edit')}}</a>
                                                <a class="dropdown-item" href="javascript:"
                                                onclick="form_alert('timeSlot-{{$timeSlot['id']}}','Want to delete this Time Slot')">{{\App\CentralLogics\translate('delete')}}  </a>
